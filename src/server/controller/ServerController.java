...
//                String client = serverConnection.getClientMessageMap()
     ...
     */
    @Override
    public String updateUsers(String input)
    {
        String s = IOUser.register(users, input);
        showUserList();
        return s;
    }

    @Override
    public void updateUserConnection(int uid, String ip, int port)
    {
        ip = ip.substring(1);
        users.get(uid-1001).setSocketInfo(ip, port);
        showUserList();
    }
